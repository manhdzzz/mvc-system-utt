    ...
    <tbody>
      <?php foreach ($rows as $i => $r): ?>
        <tr>
          ...
          <td style="text-align:center">
            <a class="action-btn edit" href="<?= BASE_URL ?>/index.php?url=TaikhoanController/edit/<?= $r["id"] ?>">Sửa</a>
            <a class="action-btn delete" onclick="return confirm('Xóa tài khoản này?')"
              href="<?= BASE_URL ?>/index.php?url=TaikhoanController/delete/<?= $r["id"] ?>">Xóa</a>
          </td>
