...
$ch   = $data["ch"] ?? null;
$err  = $data["err"] ?? "";
if(!$ch) die("Không có dữ liệu câu hỏi");
?>
<?php if($err): ?><div class="alert err"><?=htmlspecialchars($err)?></div><?php endif; ?>

<div class="page-head compact">
  <div class="page-title"><span class="icon">✏️</span><span>SỬA CÂU HỎI</span></div>
  <div class="page-actions">
    <a class="btn-gray btn-sm" href="<?=BASE_URL?>/index.php?url=CauhoiController/index&mon_id=<?=$ch["mon_id"]?>">Quay lại</a>
  </div>
</div>
