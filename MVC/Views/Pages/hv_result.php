...
<div class="box" style="padding:20px">
  <div
    ...
    <div style="text-align:right">
      ...
      <div style="color:var(--text-secondary);font-size:13px">Đúng: <?= $bl["correct_cnt"] ?>/<?= $bl["total_cnt"] ?></div>
    </div>
  </div>
</div>
...
<?php foreach ($qs as $i => $q):
  ...
  <div class="result-item <?= $dung ? 'correct' : 'wrong' ?>">
    ...
    <div class="result-answer">
      <b>Bạn chọn:</b>
      <?php if ($chon): ?>
        <span style="color:<?= $dung ? 'var(--success)' : 'var(--danger)' ?>;font-weight:700"><?= htmlspecialchars($chon) ?></span>
